...
public class telaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 170, 80));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 410, -1, 30));

        txtVal.setModel(new javax.swing.SpinnerNumberModel(1, 1, 5, 1));
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 410, -1, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(325, 440, 90, 30));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        // Sorteio do número
        double v = 1 + Math.random() * (6 - 1);
        int valor = (int) v;
        
        // Pegando valor que o usuario escolheu
        int palpite = Integer.parseInt(txtVal.getValue().toString());
        
        // Configuração das frases
        String p1 = "Acertou Miseravi!";
        String p2 = "<html>Errou! Pensei no valor " + valor + "</html>";
        String res = valor == palpite ? p1 : p2 ;
